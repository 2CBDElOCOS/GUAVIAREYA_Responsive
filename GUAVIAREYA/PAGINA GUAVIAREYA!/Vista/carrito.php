...
<body>
    <div class="container">
        ...
        <div class="subcontainer3">
            ...
            // Obtener el nombre del restaurante de la sesión
            $nombre_restaurante = isset($_SESSION['nombre_restaurante']) ? $_SESSION['nombre_restaurante'] : '';
            ...
            if (!isset($_SESSION['carrito']) || empty($_SESSION['carrito'])) {
                ...
                foreach ($_SESSION['carrito'] as $key => $producto) {
                    ...
                    $nombreRestaurante = htmlspecialchars($nombre_restaurante);
                    echo '
        <div class="row carrito" data-id="' . htmlspecialchars($producto['ID_Producto']) . '">
            <div class="col-md-2">
                <p style="font-weight: bold; text-transform: uppercase;">' . $nombreRestaurante . '</p>
