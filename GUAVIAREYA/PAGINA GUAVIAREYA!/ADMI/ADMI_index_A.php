        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-9 d-md-flex justify-content-md-end align-items-center">
            ...
            <div class="nav-icons1">
                ...
                <a href="Perfil_A.html"><i class='bx bx-user-circle'></i></a>
              </div>
          </div>
        </div>
  ...
  <section id="hero">
    <div class="subcontainer">
      <div class="row hero">
        <div class="col-md">
          <h1>GuaviareYa</h1>
            <a href="logion_A.html" target="_blank"><button style="border-radius: 30px;" >Tu tienda</button></a>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="contactanos">
      ...
      <div class="row">
        ...
        <div class="col-md-2 go-store">
            <a href="login.html" target="_blank"><button style="border-radius: 30px;">Tu tienda</button></a>
        </div>
