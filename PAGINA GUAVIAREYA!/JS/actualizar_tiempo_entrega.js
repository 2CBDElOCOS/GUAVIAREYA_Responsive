function updateEstimatedTimeAndFees() {
    ...
    const elementoCostoEnvio = document.querySelector('.costo-envio');
    const elementoSubtotal = document.querySelector('.subtotal');
    ...
    if (opcionPrioritaria && opcionPrioritaria.checked) {
    ...
    const subtotalText = elementoSubtotal.textContent.replace(/[^\d]/g, ''); // Elimina caracteres no numéricos
